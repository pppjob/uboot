...
/* SWCFGR */
#define	SWCFGR_POWERON_MASK		0x00F
#define	SWCFGR_POWERON_NORMAL		0x000
#define	SWCFGR_POWERON_CHARGER		0x001
#define	SWCFGR_POWERON_ALARM		0x002
#define	SWCFGR_POWERON_XLOAD		0x004

#define	SWCFGR_REBOOT_MASK		0x0F0
#define	SWCFGR_REBOOT_NORMAL		0x010
#define	SWCFGR_REBOOT_RECOVERY		0x020
#define	SWCFGR_REBOOT_UBOOTCMD		0x030
