...
static ps_setting_t ps_setting_default[] = {
	{D1REGC1,    "VDTV_1V8",	  PPS_DTV,    1800, PS_OFF, PS_OFF},
	...
	{D5REGC1,    "D5VDD",        	  PPS_UNUSED, 1800, PS_OFF, PS_OFF},
	{D6REGC1,    "VSD_3V0",           PPS_SD,     3000, PS_ON,  PS_ON},
	{D7REGC1,    "VBBUSB_3V3",        PPS_USB,    3300, PS_ON, PS_ON},
	{D8REGC1,    "VCMMB_CA_3V0",      PPS_CMMB,   3000, PS_OFF, PS_OFF},
	{RF1REGC1,   "VEDGE_2V8",         PPS_EDGE ,  2800, PS_OFF, PS_OFF},
	{RF2REGC1,   "UNUSED",            PPS_UNUSED, 2500, PS_OFF,  PS_OFF},
	{RF3REGC1,   "UNUSED",            PPS_UNUSED, 3000, PS_OFF, PS_OFF},
	{RF4REGC1,   "VGPS_3V0",          PPS_GPS,    3000, PS_OFF, PS_OFF},
	{IOREGC1,    "IOVDD_3V0",         PPS_COMMON, 3000, PS_ON,  PS_ON},
	{USBREGC1,   "VGA_LCD3V3",        PPS_LCD,    3300, PS_ON,  PS_ON},
	{HCREGC1,    "VCAMERA_3V0",       PPS_CAMERA, 3000, PS_OFF, PS_OFF},
	{LCREGC1,    "VDD_CRYSTAL_1V8",   PPS_COMMON, 1800, PS_OFF,  PS_OFF},
	{USIMREGC1,  "VSIM_3V0",          PPS_SIM,    3000, PS_OFF, PS_OFF},
