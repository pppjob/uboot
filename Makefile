...
w002_config: unconfig
	@$(MKCONFIG) $(@:_config=) arm atxx w002 augusta at6600

miracle_a08_config: unconfig
	@$(MKCONFIG) $(@:_config=) arm atxx miracle augusta at6600
...
gbox_config : unconfig
	@$(MKCONFIG) $(@:_config=) arm atxx gbox augusta at7700b0
#########################################################################
#########################################################################
#########################################################################
